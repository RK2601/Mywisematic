...
export default function TechConsultationServiceHero() {
      ...
      <div className="mx-auto flex max-w-container flex-col gap-12 pt-16 sm:gap-24">
        <div className="flex flex-col items-center gap-6 text-center sm:gap-12">
          ...
          <p className="text-md relative z-10 max-w-[600px] animate-appear font-medium text-muted-foreground opacity-0 delay-100 sm:text-xl">
            In today&apos;s dynamic technological landscape, we bridge the gap
            between innovation and implementation, transforming technology into
            a strategic advantage for your business.
          </p>
          <div className="relative z-10 flex animate-appear justify-center gap-4 opacity-0 delay-300">
            <Button variant="default" size="lg" asChild>
              <a href="/contact-us">Schedule Consultation</a>
            </Button>
          ...
          {/* <div className="relative pt-12">
            ...
            >
              <Mockup type="responsive">
                <Image
                  src={src}
                  alt="Technology Consultation Services"
                  width={1248}
                  height={765}
                  priority
                />
